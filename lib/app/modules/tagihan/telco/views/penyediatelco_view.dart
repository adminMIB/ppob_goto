...
import '../../pulsa-paketdata/pulsa/controllers/pulsa_controller.dart';

class PenyediatelcoView extends StatefulWidget {
  const PenyediatelcoView({Key? key}) : super(key: key);

  @override
  _PenyediatelcoViewState createState() => _PenyediatelcoViewState();
}

class _PenyediatelcoViewState extends State<PenyediatelcoView> {
  bool status = false;
