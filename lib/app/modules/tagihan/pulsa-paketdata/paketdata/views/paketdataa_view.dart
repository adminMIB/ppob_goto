...
class PaketdataaView extends StatefulWidget {
  const PaketdataaView({Key? key}) : super(key: key);

  @override
  _PaketdataaViewState createState() => _PaketdataaViewState();
}

class _PaketdataaViewState extends State<PaketdataaView> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          body: Stack(
            children: [
              GetBuilder<PaketdataController>(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children:
                                        paketdata.listPulsaOnly.map((element) {
                                      return viewprice(
