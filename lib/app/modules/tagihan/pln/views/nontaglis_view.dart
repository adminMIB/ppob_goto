...
class NontaglisView extends StatefulWidget {
  const NontaglisView({Key? key}) : super(key: key);

  @override
  _NontaglisViewState createState() => _NontaglisViewState();
}

class _NontaglisViewState extends State<NontaglisView> {
  bool status = false;
