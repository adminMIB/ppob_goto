...
class TagihanlistrikView extends StatefulWidget {
  const TagihanlistrikView({Key? key}) : super(key: key);

  @override
  _TagihanlistrikViewState createState() => _TagihanlistrikViewState();
}

class _TagihanlistrikViewState extends State<TagihanlistrikView> {
  bool status = false;
