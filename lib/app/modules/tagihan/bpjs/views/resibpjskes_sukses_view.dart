...
class ResibpjskesSuksesView extends StatefulWidget {
  final String? idpel;
  ...
  final String? no_hp;
  final String? info;
  final String? jml_keluarga;
  final String? no_va_keluarga;
  const ResibpjskesSuksesView({
    super.key,
    this.idpel,
    this.nama_pelanggan,
    this.periode,
  ...
  @override
  State<ResibpjskesSuksesView> createState() => _ResibpjskesSuksesViewState();
}

class _ResibpjskesSuksesViewState extends State<ResibpjskesSuksesView> {
