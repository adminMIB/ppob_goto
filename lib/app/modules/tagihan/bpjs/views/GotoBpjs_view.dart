...
class GotoBPJSView extends StatefulWidget {
  const GotoBPJSView({Key? key}) : super(key: key);

  @override
  _GotoBPJSViewState createState() => _GotoBPJSViewState();
}

class _GotoBPJSViewState extends State<GotoBPJSView> {
