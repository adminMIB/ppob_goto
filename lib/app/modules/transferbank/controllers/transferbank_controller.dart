...
class TransferbankController extends GetxController {
  ...
  //inquiry goto
  inquirygoto(BuildContext context, var idpel) async {
    var access_token = pref.read('access_token');

    return helperController.post(
        path: 'http://192.168.50.94:3002/api/v1/goto/inquiry',
        headers: {
          'Authorization': 'Bearer $access_token',
        },
        onSuccess: (content) {
  ...
  paymentgoto(
    ...
    return helperController.post(
      path: 'http://192.168.50.94:3002/api/v1/goto/payment',
      headers: {
        'Authorization': 'Bearer $access_token',
      },
      onSuccess: (content) {
  ...
  cekstatus(
    ...
    var access_token = pref.read('access_token');
    return helperController.post(
        path: 'http://192.168.50.94:3002/api/v1/goto/check-status/order-detail',
        headers: {
          'Authorization': 'Bearer $access_token',
        },
        onSuccess: (content) {
