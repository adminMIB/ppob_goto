...
import 'package:ppob_mpay1/app/modules/ewallet/dana/controllers/dana_controller.dart';
...
class _DanaViewState extends State<DanaView> {
  ...
  final danaController = Get.put(DanaController());
            ...
            body: Stack(
              children: [
                SafeArea(
                  ...
                  children: [
                    Expanded(
                      child: GetBuilder<DanaController>(
                        init: DanaController(),
