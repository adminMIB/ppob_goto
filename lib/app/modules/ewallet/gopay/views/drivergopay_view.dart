...
class DriverGopayView extends StatefulWidget {
  const DriverGopayView({Key? key}) : super(key: key);

  @override
  _DriverGopayViewState createState() => _DriverGopayViewState();
}

class _DriverGopayViewState extends State<DriverGopayView> {
  bool status = false;
