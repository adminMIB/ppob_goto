...
class _OvoViewState extends State<OvoView> {
  ...
  final ovoController = Get.put(OvoController());
            ...
            body: Stack(
              children: [
                SafeArea(
                  ...
                  children: [
                    Expanded(
                      child: GetBuilder<OvoController>(
                        init: OvoController(),
                            ...
                            children: [
                                  ...
                                  Text(
                                    'OVO' +
                                        ...
                                        NumberFormat.currency(
                                          ...
                                          symbol: '',
                                          decimalDigits: 0,
                                        ).format(double.parse(element.price)),
                                    style: TextStyle(
                              ...
                              Text(
                                NumberFormat.currency(
                                  ...
                                  symbol: 'Rp.',
                                  decimalDigits: 0,
                                ).format(int.parse(element.price)),
                                style: TextStyle(
